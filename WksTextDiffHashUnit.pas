...
// crc algorithm courtesy of Earl F.Glynn (http://www.efg2.com/Lab/Mathematics/CRC.htm)
function  Crc32Calc(const s: string; len: integer): Cardinal;
var
  i, l: integer; // byteLen
  p: PByte;
begin
