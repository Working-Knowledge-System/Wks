inherited EquipmentMainForm: TEquipmentMainForm
  Margins.Right = 16
  Caption = 'EquipmentMainForm'
  Position = poDesigned
  ...
  inherited TopPanel: TPanel
    ...
    inherited TopPageControl: TPageControl
      ...
      object EquipmentTabSheet: TTabSheet
        Caption = 'Equipment'
        ImageIndex = 2
        object EquipmentToolBar: TToolBar
          Left = 0
          Top = 0
          Width = 52
          Height = 44
          ...
          ButtonHeight = 46
          ButtonWidth = 52
          Caption = 'EquipmentToolBar'
          Images = EquipmentImageList24
          ShowCaptions = True
          TabOrder = 0
          object EquipmentTestToolButton: TToolButton
            Left = 0
            Top = 0
            Action = EquipmentTestAction
          end
        end
      end
    end
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object EquipmentJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Equipment'
            ...
            object EquipmentWksRecordEditCtrl: TWksRecordEditCtrl
              ...
              OnDataLoaded = EquipmentWksRecordEditCtrlDataLoaded
            end
          end
          object EquipmentConfigurationJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            ...
            Beveled = False
            ParentButtonFont = False
            object EquipmentConfigurationWksRecordEditCtrl: TWksRecordEditCtrl
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 273
              ...
              BorderStyle = bsNone
              TabOrder = 0
              DataSource = EquipmentConfigurationDataSource
              OnDataLoaded = EquipmentConfigurationWksRecordEditCtrlDataLoaded
            end
          end
          object EquipmentProcessJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Process'
            ...
            Beveled = False
            ParentButtonFont = False
            object EquipmentProcessWksRecordEditCtrl: TWksRecordEditCtrl
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 273
              ...
              BorderStyle = bsNone
              TabOrder = 0
              DataSource = EquipmentProcessDataSource
              OnDataLoaded = EquipmentProcessWksRecordEditCtrlDataLoaded
            end
          end
          object EquipmentCommercialJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Commercial'
            ...
            ParentButtonFont = False
            object EquipmentCommercialWksRecordEditCtrl: TWksRecordEditCtrl
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 273
              ...
              BorderStyle = bsNone
              TabOrder = 0
              DataSource = EquipmentCommercialDataSource
              OnDataLoaded = EquipmentCommercialWksRecordEditCtrlDataLoaded
              ExplicitHeight = 75
            end
          end
        end
  ...
  inherited MainPanel: TPanel
    ...
    inherited MainPageControl: TPageControl
      ...
      object CollectionTabSheet: TTabSheet
        Hint = 'Data collections definitions'
        Caption = 'Collections'
        ImageIndex = 9
      end
      ...
      object MaintenanceTabSheet: TTabSheet
        Hint = 'Maintenance definition and history'
        Caption = 'Maintenances'
        ImageIndex = 5
      end
      object SpareTabSheet: TTabSheet
        Hint = 'Spare part lists'
        Caption = 'Spares'
        ImageIndex = 6
      end
      object ChangeTabSheet: TTabSheet
        Hint = 'Changes history'
        Caption = 'Changes'
        ImageIndex = 7
      end
    end
  end
  object EquipmentClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'EquipmentDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = EquipmentClientDataSetAfterInsert
    AfterDelete = EquipmentClientDataSetAfterDelete
    Left = 72
    Top = 432
  end
  object EquipmentDataSource: TDataSource [16]
    DataSet = EquipmentClientDataSet
    Left = 208
    Top = 432
  end
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksEquipmentSoapProject.dll/soap'
  end
  object EquipmentImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object EquipmentAction: TActionList [28]
    Images = EquipmentImageList24
    Left = 584
    Top = 544
    object EquipmentTestAction: TAction
      Caption = '    Test    '
      Hint = 'Just a test'
      ImageIndex = 0
      OnExecute = EquipmentTestActionExecute
    end
  end
  object EquipmentConfigurationClientDataSet: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'FldObjectId'
    MasterFields = 'FldId'
    MasterSource = ObjectDataSource
    PacketRecords = 0
    Params = <>
    ProviderName = 'EquipmentConfigurationDataSetProvider'
    RemoteServer = MainSoapConnection
    Left = 72
    Top = 488
  end
  object EquipmentConfigurationDataSource: TDataSource
    DataSet = EquipmentConfigurationClientDataSet
    Left = 208
    Top = 488
  end
  object EquipmentProcessClientDataSet: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'FldObjectId'
    MasterFields = 'FldId'
    MasterSource = ObjectDataSource
    PacketRecords = 0
    Params = <>
    ProviderName = 'EquipmentProcessDataSetProvider'
    RemoteServer = MainSoapConnection
    Left = 72
    Top = 544
  end
  object EquipmentProcessDataSource: TDataSource
    DataSet = EquipmentProcessClientDataSet
    Left = 208
    Top = 544
  end
  object EquipmentCommercialClientDataSet: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'FldObjectId'
    MasterFields = 'FldId'
    MasterSource = ObjectDataSource
    PacketRecords = 0
    Params = <>
    ProviderName = 'EquipmentCommercialDataSetProvider'
    RemoteServer = MainSoapConnection
    Left = 72
    Top = 600
  end
  object EquipmentCommercialDataSource: TDataSource
    DataSet = EquipmentCommercialClientDataSet
    Left = 208
    Top = 600
  end
end
