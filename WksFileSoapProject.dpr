...
uses
  ...
  WksFileSoapMainWebModuleUnit in 'WksFileSoapMainWebModuleUnit.pas' {FileMainWebModule: TWebModule},
  WksFileSoapMainDataModuleUnit in 'WksFileSoapMainDataModuleUnit.pas' {FileMainDataModule: TSoapDataModule},
  WksFileSoapMainServiceImpl in 'WksFileSoapMainServiceImpl.pas',
