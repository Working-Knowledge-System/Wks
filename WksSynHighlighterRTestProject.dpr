...
program WksSynHighlighterRTestProject;

uses
  Forms,
  WksSynHighlighterRTestMainFormUnit in 'WksSynHighlighterRTestMainFormUnit.pas' {Form1},
  WksSynHighlighterRUnit in 'WksSynHighlighterRUnit.pas';
