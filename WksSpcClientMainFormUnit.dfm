inherited SpcMainForm: TSpcMainForm
  Caption = 'SpcMainForm'
  ...
  inherited TopPanel: TPanel
    ...
    inherited TopPageControl: TPageControl
      ...
      object SpcTabSheet: TTabSheet
        Caption = 'Spc'
        ImageIndex = 2
        object SpcToolBar: TToolBar
          Left = 0
          Top = 0
          Width = 52
          Height = 44
          ...
          ButtonWidth = 52
          Caption = 'SpcToolBar'
          Images = SpcImageList24
          ShowCaptions = True
          TabOrder = 0
          object SpcTestToolButton: TToolButton
            Left = 0
            Top = 0
            Action = SpcTestAction
          end
        end
      end
    end
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object SpcJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Spc'
            ...
            object SpcDBNavigator: TDBNavigator
            ...
            object SpcWksRecordEditCtrl: TWksRecordEditCtrl
              AlignWithMargins = True
              Left = 3
              Top = 53
              Width = 273
              ...
              TabOrder = 1
              DataSource = SpcDataSource
              OnDataLoaded = SpcWksRecordEditCtrlDataLoaded
            end
          end
        end
      end
  ...
  object SpcClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'SpcDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = SpcClientDataSetAfterInsert
    AfterPost = SpcClientDataSetAfterPost
    AfterDelete = SpcClientDataSetAfterDelete
    OnReconcileError = SpcClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object SpcDataSource: TDataSource [16]
    DataSet = SpcClientDataSet
    Left = 208
    Top = 432
  end
  object SpcImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object SpcAction: TActionList [28]
    Images = SpcImageList24
    Left = 584
    Top = 544
    object SpcTestAction: TAction
      Caption = '    Test    '
      Hint = 'Just a test'
      ImageIndex = 0
      OnExecute = SpcTestActionExecute
    end
  end
end
