inherited ItemMainForm: TItemMainForm
  Caption = 'ItemMainForm'
    ...
    inherited TopPageControl: TPageControl
      ...
      object ItemTabSheet: TTabSheet
        ...
        object ItemToolBar: TToolBar
          ...
          ButtonWidth = 52
          Caption = 'ItemToolBar'
          Images = ItemImageList24
          ShowCaptions = True
          TabOrder = 0
          object ItemTestToolButton: TToolButton
            Left = 0
            Top = 0
            Action = ItemTestAction
          end
        end
      end
    end
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object ItemJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 120
            Caption = 'Item'
            ExpandedHeight = 120
            ...
            object ItemWksRecordEditCtrl: TWksRecordEditCtrl
              AlignWithMargins = True
              Left = 3
              Top = 53
              Width = 273
              ...
              TabOrder = 1
              DataSource = ItemDataSource
              OnDataLoaded = ItemWksRecordEditCtrlDataLoaded
            end
          end
        end
      end
  ...
  object ItemClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'ItemDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = ItemClientDataSetAfterInsert
    AfterPost = ItemClientDataSetAfterPost
    AfterDelete = ItemClientDataSetAfterDelete
    OnReconcileError = ItemClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object ItemDataSource: TDataSource [16]
    DataSet = ItemClientDataSet
    Left = 208
    Top = 432
  end
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksItemSoapProject.dll/soap'
  end
  object ItemImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object ItemAction: TActionList [28]
    Images = ItemImageList24
    Left = 584
    Top = 544
    object ItemTestAction: TAction
      Caption = '    Test    '
      Hint = 'Just a test'
      ImageIndex = 0
      OnExecute = ItemTestActionExecute
    end
  end
end
