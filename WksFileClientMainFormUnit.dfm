inherited FileMainForm: TFileMainForm
  Caption = 'FileMainForm'
  ClientWidth = 1584
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object FileJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'File'
            ...
            object FileObjectIdLabel: TLabel
            ...
            object FileObjectIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 74
              Width = 260
            ...
            object FileValue1DBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 224
              Width = 260
            ...
            object FileValue2DBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 274
              Width = 260
            ...
            object FileDBNavigator: TDBNavigator
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 286
  ...
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksFileSoapProject.dll/soap'
  end
  object FileImageList24: TImageList [25]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object FileAction: TActionList [26]
    Images = FileImageList24
    Left = 584
    Top = 544
  end
  object FileDataSource: TDataSource
    DataSet = FileClientDataSet
    Left = 208
    Top = 432
  end
  object FileClientDataSet: TClientDataSet
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'FileDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = FileClientDataSetAfterInsert
    AfterPost = FileClientDataSetAfterPost
    AfterDelete = FileClientDataSetAfterDelete
    OnReconcileError = FileClientDataSetReconcileError
    Left = 72
    Top = 432
  end
end
