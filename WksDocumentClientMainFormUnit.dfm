inherited DocumentMainForm: TDocumentMainForm
  Caption = 'DocumentMainForm'
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object DocumentJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Document'
            ...
            object DocumentObjectIdLabel: TLabel
            ...
            object DocumentPIdLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 153
              Width = 260
            ...
            object DocumentKindLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 253
              Width = 260
            ...
            object DocumentObjectIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 74
              Width = 260
            ...
            object DocumentPIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 174
              Width = 260
            ...
            object DocumentIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 124
              Width = 260
            ...
            object DocumentDBEdit: TDBEdit
              ...
              Margins.Right = 16
              Align = alTop
              DataField = 'FldDocument'
              DataSource = DocumentDataSource
              TabOrder = 3
            end
            object DocumentDBNavigator: TDBNavigator
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 286
            ...
            object DocumentKindDBComboBox: TDBComboBox
              AlignWithMargins = True
              Left = 16
              Top = 274
              Width = 260
  ...
  object DocumentClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'DocumentDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = DocumentClientDataSetAfterInsert
    AfterPost = DocumentClientDataSetAfterPost
    AfterDelete = DocumentClientDataSetAfterDelete
    OnReconcileError = DocumentClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object DocumentDataSource: TDataSource [16]
    DataSet = DocumentClientDataSet
    Left = 208
    Top = 432
  end
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksDocumentSoapProject.dll/soap'
  end
  object DocumentImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object DocumentAction: TActionList [28]
    Images = DocumentImageList24
    Left = 584
    Top = 544
  end
end
