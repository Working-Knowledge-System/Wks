inherited FormMainForm: TFormMainForm
  Caption = 'FormMainForm'
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object FormJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Form'
            ...
            object FormObjectIdLabel: TLabel
            ...
            object FormObjectIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 74
              Width = 260
            ...
            object FormValue1DBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 224
              Width = 260
            ...
            object FormValue2DBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 274
              Width = 260
            ...
            object FormDBNavigator: TDBNavigator
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 286
  ...
  object FormClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'FormDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = FormClientDataSetAfterInsert
    AfterPost = FormClientDataSetAfterPost
    AfterDelete = FormClientDataSetAfterDelete
    OnReconcileError = FormClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object FormDataSource: TDataSource [16]
    DataSet = FormClientDataSet
    Left = 208
    Top = 432
  end
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksFormSoapProject.dll/soap'
  end
  object FormImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
  ...
  object FormAction: TActionList [28]
    Images = FormImageList24
    Left = 584
    Top = 544
  end
end
