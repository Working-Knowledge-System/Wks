inherited InvoiceMainForm: TInvoiceMainForm
    ...
    inherited RightPageControl: TPageControl
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object InvoiceJvScrollMaxBand: TJvScrollMaxBand
            Width = 292
            Height = 21
            Expanded = False
            Caption = 'Invoice'
            ...
            object InvoiceObjectIdLabel: TLabel
            ...
            object InvoiceValue1Label: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 153
              Width = 260
            ...
            object InvoiceObjectIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 74
              Width = 260
            ...
            object InvoiceIdDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 124
              Width = 260
            ...
            object InvoiceValue1DBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 174
              Width = 260
            ...
            object InvoiceDBNavigator: TDBNavigator
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 286
  ...
  object InvoiceClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'InvoiceDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = InvoiceClientDataSetAfterInsert
    AfterPost = InvoiceClientDataSetAfterPost
    AfterDelete = InvoiceClientDataSetAfterDelete
    OnReconcileError = InvoiceClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object InvoiceDataSource: TDataSource [16]
    DataSet = InvoiceClientDataSet
    Left = 208
    Top = 432
  end
  inherited MainSoapConnection: TSoapConnection
    URL = 'http://localhost/WksInvoiceSoapProject.dll/soap'
  end
  object InvoiceImageList24: TImageList [27]
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 376
