inherited AccountMainForm: TAccountMainForm
      ...
      inherited PropertyTabSheet: TTabSheet
        inherited ObjectJvScrollMax: TJvScrollMax
          ...
          object AccountJvScrollMaxBand: TJvScrollMaxBand
            ...
            object AccountDBNavigator: TDBNavigator
              AlignWithMargins = True
              Left = 3
              Top = 22
              Width = 286
            ...
            object AccountUsernameDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 170
              Width = 260
            ...
            object AccountPasswordDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 218
              Width = 260
            ...
            object AccountEmailDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 122
              Width = 260
          ...
          object AccountHooksJvScrollMaxBand: TJvScrollMaxBand
            ...
            Beveled = False
            ParentButtonFont = False
            object AccountLogoutHookLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 77
              Width = 260
            ...
            object AccountLoginHookLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 27
              Width = 260
            ...
            object AccountLogoutHookDBEdit: TDBEdit
              ...
              Margins.Right = 16
              Align = alTop
              DataField = 'FldLogoutHook'
              DataSource = AccountDataSource
              TabOrder = 0
            end
            object AccountLoginHookDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 48
              Width = 260
          ...
          object AccountSecurityJvScrollMaxBand: TJvScrollMaxBand
            ...
            Beveled = False
            ParentButtonFont = False
            object AccountSecureQuestionLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 35
              Width = 260
              ...
              Margins.Right = 16
              Align = alTop
              Caption = 'Secure Question'
              ExplicitWidth = 86
            end
            object AccountSecureResponseLabel: TLabel
              AlignWithMargins = True
              Left = 16
              Top = 85
              Width = 260
              ...
              Margins.Right = 16
              Align = alTop
              Caption = 'Secure Response'
              ExplicitWidth = 88
            end
            object AccountSecureQuestionDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 56
              Width = 260
              ...
              Margins.Right = 16
              Align = alTop
              DataField = 'FldSecureQuestion'
              DataSource = AccountDataSource
              ParentShowHint = False
              ShowHint = True
              TabOrder = 0
            end
            object AccountSecureResponseDBEdit: TDBEdit
              AlignWithMargins = True
              Left = 16
              Top = 106
              Width = 260
  ...
  object AccountClientDataSet: TClientDataSet [15]
    Aggregates = <>
    ...
    PacketRecords = 0
    Params = <>
    ProviderName = 'AccountDataSetProvider'
    RemoteServer = MainSoapConnection
    AfterInsert = AccountClientDataSetAfterInsert
    AfterPost = AccountClientDataSetAfterPost
    AfterDelete = AccountClientDataSetAfterDelete
    OnReconcileError = AccountClientDataSetReconcileError
    Left = 72
    Top = 432
  end
  object AccountDataSource: TDataSource [16]
